...
public class MoveDocumentTest extends AbstractAuditIntegrationTestBase {

    public static final String DESTINATION_FOLDER = "MOVE_FOLDER";
    public static final String REQUEST_URI_FIXTURE = "/alfresco/s/slingshot/doclib/action/move-to/site/mytestsite/documentLibrary"
            + NESTED_TEST_FOLDER;

    /**
     * Constructor.
     */
    public MoveDocumentTest() {
        super(new MoveDocumentAuditEventListener());
    }
