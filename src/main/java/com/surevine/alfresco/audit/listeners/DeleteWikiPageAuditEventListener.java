 ...
 * 
 */
public class DeleteWikiPageAuditEventListener extends DeleteAuditEventListener {

    /**
     * Name of the event.
     */
    private static final String ACTION = "WIKI_PAGE_DELETED";
