 ...
 * 
 */
public class EditDiscussionTopicAuditEventListener extends PutAuditEventListener {


    /**
     * Name of the event.
     */
    private static final String ACTION = "DISCUSSION_TOPIC_UPDATED";
     ...
     */
    public EditDiscussionTopicAuditEventListener() {
    ...
    @Override
    public void setSpecificAuditMetadata(final Auditable auditable, final HttpServletRequest request, final JSONObject json, final BufferedHttpServletResponse response) throws JSONException {
